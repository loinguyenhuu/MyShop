...
import sp1 from '../../../media/product/64.jpg';
import sp2 from '../../../media/product/66.jpg';
import sp3 from '../../../media/product/70.jpg';
import sp4 from '../../../media/product/72.jpg';
import sp5 from '../../../media/product/74.jpg';
import sp6 from '../../../media/product/131.jpg';
import sp7 from '../../../media/product/134.jpg';
import sp8 from '../../../media/product/135.jpg';
                ...
                <ScrollView style={wrapper}>
                    ...
                    <View style={productContainer}>
                        ...
                        <View style={productInfo}>
                            <Text style={txtName}>High Slit Maxi</Text>
                    ...
                    <View style={productContainer}>
                        ...
                        <View style={productInfo}>
                            <Text style={txtName}>Tie Waist Popo</Text>
                            <Text style={txtPrice}>117$</Text>
                            <Text style={txtMaterial}>Material silk</Text>
                            <View style={lastRowInfo}>
                    ...
                    <View style={productContainer}>
                        ...
                        <View style={productInfo}>
                            <Text style={txtName}>Mock Neck Zip</Text>
                            <Text style={txtPrice}>117$</Text>
                            <Text style={txtMaterial}>Material silk</Text>
                            <View style={lastRowInfo}>
                    ...
                    <View style={productContainer}>
                        ...
                        <View style={productInfo}>
                            <Text style={txtName}>Lace Trim Surp</Text>
                            <Text style={txtPrice}>117$</Text>
                            <Text style={txtMaterial}>Material silk</Text>
                            <View style={lastRowInfo}>
