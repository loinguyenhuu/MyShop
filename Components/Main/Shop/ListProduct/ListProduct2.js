...
import sp1 from '../../../media/product/78.jpg';
import sp2 from '../../../media/product/80.jpg';
import sp3 from '../../../media/product/82.jpg';
import sp4 from '../../../media/product/84.jpg';
import sp5 from '../../../media/product/86.jpg';
import sp6 from '../../../media/product/136.jpg';
import sp7 from '../../../media/product/137.jpg';
import sp8 from '../../../media/product/138.jpg';
            ...
            <View style={container}>
                <ScrollView style={wrapper}>
                    <View style={header}>
                        ...
                        <Text style={ titleStyle}>Mini Dress</Text>
                        <View style={{width:30}}/>
                    </View>
                    <View style={productContainer}>
                        <Image style={productImage} source={sp1}/>
                        <View style={productInfo}>
                            <Text style={txtName}>Mesh Embellish</Text>
                    ...
                    <View style={productContainer}>
                        ...
                        <View style={productInfo}>
                            <Text style={txtName}>Ruffle Wrap Fr</Text>
                            <Text style={txtPrice}>117$</Text>
                            <Text style={txtMaterial}>Material silk</Text>
                            <View style={lastRowInfo}>
                    ...
                    <View style={productContainer}>
                        ...
                        <View style={productInfo}>
                            <Text style={txtName}>Cold Shoulder</Text>
                            <Text style={txtPrice}>117$</Text>
                            <Text style={txtMaterial}>Material silk</Text>
                            <View style={lastRowInfo}>
