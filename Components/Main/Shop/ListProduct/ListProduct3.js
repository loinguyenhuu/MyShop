...
import sp1 from '../../../media/product/88.jpg';
import sp2 from '../../../media/product/90.jpg';
import sp3 from '../../../media/product/92.jpg';
import sp4 from '../../../media/product/94.jpg';
import sp5 from '../../../media/product/96.jpg';
import sp6 from '../../../media/product/140.jpg';
import sp7 from '../../../media/product/142.jpg';
import sp8 from '../../../media/product/144.jpg';
            ...
            <View style={container}>
                <ScrollView style={wrapper}>
                    <View style={header}>
                        ...
                        <Text style={ titleStyle}>Rompers Dress</Text>
                        <View style={{width:30}}/>
                    </View>
                    <View style={productContainer}>
                        <Image style={productImage} source={sp1}/>
                        <View style={productInfo}>
                            <Text style={txtName}>Asymmetrical G</Text>
                            ...
                            <View style={lastRowInfo}>
                                ...
                                <TouchableOpacity onPress={() => {this.props.navigation.navigate('ManHinh_ProductDetail5')}}>
                    ...
                    <View style={productContainer}>
                        ...
                        <View style={productInfo}>
                            <Text style={txtName}>Floral Surplic</Text>
                            <Text style={txtPrice}>117$</Text>
                            <Text style={txtMaterial}>Material silk</Text>
                            <View style={lastRowInfo}>
                    ...
                    <View style={productContainer}>
                        ...
                        <View style={productInfo}>
                            <Text style={txtName}>Faux Wrap Chif</Text>
                            <Text style={txtPrice}>117$</Text>
                            <Text style={txtMaterial}>Material silk</Text>
                            <View style={lastRowInfo}>
                                <Text style={txtColor}>Color Royal</Text>
                                <View style={{backgroundColor:'cyan', height:15, width:15, borderRadius:5}}/>
