...
import img1 from '../../../media/product/82.jpg';
import img2 from '../../../media/product/83.jpg';
                ...
                <View style={cardStyle}>
                    ...
                    <View style={footer}>
                        ...
                        <View style={descContainer}>
                            <Text style={descStyle}>Weddings or red carpets, this dress is ready for anything. With plunging keyhole cut-outs and skin-baring strappy sides, less is more when it comes to this dramatic look. Add a fabulous heel, and you've got effortlessly glamorous style on lock.</Text>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 8 }}>
                                <Text style={txtMaterial}>Material ful</Text>
