...
import img1 from '../../../media/product/72.jpg';
import img2 from '../../../media/product/73.jpg';
                ...
                <View style={cardStyle}>
                    ...
                    <View style={footer}>
                        ...
                        <View style={descContainer}>
                            <Text style={descStyle}>Let your shoulder steal the show in this sweet and sultry maxi dress featuring a smocked bodice and flowing skirt. The soft, stretchy fabric offers a perfectly comfortable fit every time, while a bold print keeps eyes on you.</Text>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 8 }}>
                                <Text style={txtMaterial}>Material silk</Text>
                                <View style={{ flexDirection: 'row' }} >
                                    <Text style={txtColor}>Color DarkGoldenRod</Text>
