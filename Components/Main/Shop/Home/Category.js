...
import rompers from '../../../media/temp/rompers.jpg';
        ...
        return (
            <View style={wrapper}>
                ...
                <Swiper  width={imageWidth} height={imageHeight}>
                    ...
                    <TouchableOpacity onPress={() => {this.props.navigation.navigate('ManHinh_ListProduct1')}}>
                        <ImageBackground source={partyIcon} style={imageStyle}>
                            <Text style={cateTitle}>Party Dress</Text>
                        </ImageBackground>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => {this.props.navigation.navigate('ManHinh_ListProduct2')}}>
                        <ImageBackground source={litterIcon} style={imageStyle}>
                            <Text style={cateTitle}>Mini Dress</Text>
                        </ImageBackground>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => {this.props.navigation.navigate('ManHinh_ListProduct3')}}>
                        <ImageBackground source={rompers} style={imageStyle}>
                            <Text style={cateTitle}>Rompers Dress</Text>
                        </ImageBackground>
                    </TouchableOpacity>
                </Swiper>
                </View>
